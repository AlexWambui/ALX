...
class BasicAuth(Auth):
    """
    Creates basic authentication for the API
    """

    def extract_base64_authorization_header(self,
                                            authorization_header: str) -> str:
        """
        Returns Base64 for authorization header
        """
    ...
    def decode_base64_authorization_header(self,
            ...
            -> str:
        """
        Returns a decode of the base64 string
    ...
    def extract_user_credentials(self,
            ...
            -> (str, str):
        """
        Returns email and password from
    ...
    def current_user(self, request=None) -> TypeVar('User'):
        """
        Overloads Auth and retrieves the User instance for request
        """
